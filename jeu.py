...
def arena(XM,YM):
    if Player['x']>=635:                                                                      #Dès que le joueur est asser à droite de l'écran
        XM-=640                                                                                  #la tilemap va 1 écran à droite
        Player['x']-=630
        Wario['x']-=630

    elif Player['x']<=5:                                                                      #Dès que le joueur est asser à gauche de l'écran
        XM=XM+640                                                                              #la tilemap va 1 écran à gauche
        Player['x']+=630
        Wario['x']+=630
    
    elif Player['y']>=315:                                                                    #Dès que le joueur est asser en haut de l'écran
        YM-=320                                                                                  #la tilemap va 1 écran en haut
        Player['y']-=310
        Wario['y']-=310
    
    elif Player['y']<=5:                                                                      #Dès que le joueur est asser en bas de l'écran
        YM=YM+320                                                                              #la tilemap va 1 écran en bas
        Player['y']+=310
        Wario['y']+=310
    type(Wario)
